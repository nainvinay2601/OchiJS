...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen px-20 py-10 bg-zinc-100 text-black ">
      <div className="w-1/2 h-full flex flex-col justify-between  font-founders-grotesk  ">
        <div className="footerTitle">
          <h1 className="text-[10vw] uppercase leading-[.75]">Eye-</h1>
          <h1 className="text-[10vw] uppercase leading-[.75]">Opening</h1>
        </div>
      ...
      <div className="w-1/2 font-founders-grotesk ">
        <h1 className="text-[10vw] uppercase leading-[.75] pb-10">Presentations</h1> 
       
       {/* <a href="#">hello</a><a href=""></a><a href=""></a> */} 

       {["Instagram", "twitter","Behance" , "LinkedIn"].map((item,index)=>{
        return(
            <a className='block capitalize font-neue-montreal ' key={index} href="#">{item} </a>
        )
       })}
